...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder> {
    ...
    public onChatUserListener listener;


    public interface onChatUserListener {
        void onChatUserClick(int position, View view);
    }

    public void setListener(onChatUserListener listener){
        this.listener = listener;
    }

    public UserAdapter(Context mContext, List<UserProfileData> mUsers, boolean isChat){
        this.mUsers = mUsers;
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        UserProfileData user = mUsers.get(position);
        ...
        if(isChat){
            ...
            holder.last_msg.setText(View.GONE);
        }
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    listener.onChatUserClick(getAdapterPosition(),v);
                }
            });
